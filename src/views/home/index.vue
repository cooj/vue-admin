<template>
    <div class="layout-pd home-container">
        <el-row :gutter="15" class="home-card-one mb15">
            <el-col v-for="(v, k) in state.homeOne"
                :key="k"
                :xs="24"
                :sm="12"
                :md="12"
...
// 折线图
const initLineChart = () => {
    if (!state.global.dispose.includes(state.global.homeChartOne)) state.global.homeChartOne.dispose()
...
// 饼图
const initPieChart = () => {
    if (!state.global.dispose.includes(state.global.homeChartTwo)) state.global.homeChartTwo.dispose()
...
// 柱状图
const initBarChart = () => {
    if (!state.global.dispose.includes(state.global.homeCharThree)) state.global.homeCharThree.dispose()
