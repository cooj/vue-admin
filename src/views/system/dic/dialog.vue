                ...
                <el-row :gutter="35">
                    <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                        <el-form-item label="字典名称">
                            <el-input v-model="state.ruleForm.dicName" placeholder="请输入字典名称" clearable />
                        </el-form-item>
                    </el-col>
                    <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                        <el-form-item label="字段名">
                            <el-input v-model="state.ruleForm.fieldName" placeholder="请输入字段名，拼接 ruleForm.list" clearable />
                        </el-form-item>
                    </el-col>
                        ...
                        <el-row v-for="(v, k) in state.ruleForm.list" :key="k" :gutter="35">
                            <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                                <el-form-item :prop="`list[${k}].label`">
                                    <template #label>
                                        <el-button v-if="k === 0" type="primary" circle size="small" @click="onAddRow">
                                            <el-icon>
                                                <ele-Plus />
                                            </el-icon>
                                        </el-button>
                                        <el-button v-else type="danger" circle size="small" @click="onDelRow(k)">
                                            <el-icon>
                                                <ele-Delete />
                                            </el-icon>
                                        </el-button>
